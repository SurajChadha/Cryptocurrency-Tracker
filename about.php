...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous"> 
  ...
  <!-- <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" 
            aria-haspopup="true" aria-expanded="false" href="#" style="color:blue;"> <img src="https://img.icons8.com/metro/26/000000/guest-male.png"></a>
...
<div class="container mt-3">
    <h2>Details about cryptocurrencies are listed here</h2>
    <hr>
<div class="accordion" id="accordionExample">
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      ...
      Presently, there are over 5000 types of cryptocurrencies. A common factor among all Altcoins is that they can serve as a substitute for Bitcoin. However, each Altcoins has unique features and offers something different when compared to other Altcoins and Bitcoin. Just like Bitcoin, Altcoins offer investors opportunities to make money off them. You need to select the right cryptocurrency to buy in order to make a profit on your investment. 
  ...
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
      The cryptocurrency market has blossomed in the past few months as Bitcoin hit an all-time high of $61000, which has in turn increased the demand to mine these digital assets. However, crypto mining remains way out of reach to most investors due to the cost of mining equipment and electricity costs.
